...
/* harmony import */ var _currency_converter_currency_converter_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./currency-converter/currency-converter.component */ "./src/app/currency-converter/currency-converter.component.ts");
/* harmony import */ var _currency_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./currency.service */ "./src/app/currency.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _currency_converter_currency_converter_component__WEBPACK_IMPORTED_MODULE_7__["CurrencyConverterComponent"]
            ],
            imports: [
            ...
            providers: [
                _currency_service__WEBPACK_IMPORTED_MODULE_8__["CurrencyService"]
            ],
...
/***/ "./src/app/currency-converter/currency-converter.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/currency-converter/currency-converter.component.html ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = ".form {\n  width: 220px;\n  margin: 48px auto; }\n  .form .line {\n    width: 100%;\n    display: inline-block;\n    margin: 24px 0; }\n  .form .line .line-title {\n      line-height: 3; }\n  .form .line .line-element {\n      display: inline-flex; }\n  .form .line .line-element.full {\n        width: 100%; }\n  .form .line .line-element.full .mat-button-toggle {\n          width: 50%;\n          text-align: center; }\n  .form .line .line-element.gc-small {\n        width: 38%; }\n  .form .line .line-element.gc-large {\n        width: 62%; }\n  .form .line .line-element button {\n        display: block;\n        margin: 0 auto; }\n  .result {\n  width: 320px;\n  margin: 48px auto; }\n  .result .line {\n    box-sizing: border-box;\n    display: flex;\n    margin: 6px auto 12px auto; }\n  .fill-remaining-space {\n  flex: 1 1 auto; }\n  .mat-input-element {\n  text-align: center; }\n  .select-currency {\n  border-radius: 0;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.42);\n  height: 36px;\n  align-items: baseline;\n  box-sizing: border-box; }\n"
...
var CurrencyConverterComponent = /** @class */ (function () {
    function CurrencyConverterComponent(_formBuilder, _currencyService) {
    ...
    CurrencyConverterComponent.prototype.buildForm = function () {
        this.cForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            productValue: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]({ value: 100, disabled: false }, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
            date: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]({ value: this.maxDate, disabled: true }, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
            country: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]({ value: this.countries[0].tax, disabled: false }, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required)
        });
    };
    CurrencyConverterComponent.prototype.onValueChanged = function (data) {
        var _this = this;
        var form = this.cForm;
    ...
    CurrencyConverterComponent.prototype.submitData = function () {
        var _this = this;
        var from_to = this.selectedCurr + '_CHF';
        // date must be in format as: 2018-05-18
        var date = moment(new Date(this.cForm.controls['date'].value)).format('YYYY-MM-DD');
        this._currencyService.calCur(from_to, date)
            .subscribe(function (result) {
            var chfValue = result.body[from_to].val[date];
            _this.calculate(chfValue);
        }, function (error) {
            console.error(error);
        });
    };
    CurrencyConverterComponent.prototype.calculate = function (val) {
        var productValue = this.cForm.controls['productValue'].value;
    ...
    CurrencyConverterComponent.prototype.setCurrency = function (curr) {
        this.selectedCurr = curr;
    };
    CurrencyConverterComponent.prototype.updateCurrency = function () {
    ...
    CurrencyConverterComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./currency-converter.component.html */ "./src/app/currency-converter/currency-converter.component.html"),
            styles: [__webpack_require__(/*! ./currency-converter.component.scss */ "./src/app/currency-converter/currency-converter.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            _currency_service__WEBPACK_IMPORTED_MODULE_2__["CurrencyService"]])
...
var CurrencyService = /** @class */ (function () {
     ...
     */
    CurrencyService.prototype.calCur = function (from_to, date) {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].currencyconverterapi + 'convert?q=' + from_to + '&compact=y' + '&date=' + date;
        return this.http.get(url, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response;
...
module.exports = __webpack_require__(/*! /Users/ak/www/test/importado/src/main.ts */"./src/main.ts");
